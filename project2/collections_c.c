//Name: collection_c.c
//Purpose: Improvements to determining what Bob can buy with his budget
...
int main(void)
{
    ...
    if ( (collection_price1 <= budget) + (collection_price2 <= budget) + (collection_price3 <= budget) >= 3)
        {
    ...
    if ( (collection_price1 <= budget) + (collection_price2 <= budget) + (collection_price3 <= budget) == 0)
        {
